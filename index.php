						...
						<ul id="actions">
							...
							<?php
								if (!empty($arrayUser)) {
									...
									echo '<li><a class="various" data-fancybox-type="iframe" href="login.html">Iniciar Sesion</a></li>';
									echo '<li><a class="signinLight" data-fancybox-type="iframe" href="registro.php">Registro</a></li>';;
								}
